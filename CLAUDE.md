...
This is a **documentation website** for Glyph - a platform providing unified payment infrastructure ("One API key. Infinite agents.") enabling AI agents to make payments via the x402 protocol. The docs site is built with Vite + React + TypeScript.
...
- `/app/tailwind.config.js` - Tailwind with custom GLYPH theme colors
